    ...
    <div id="slider" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="d-block w-100"  src="img/monstera-slider1.jpg" alt="First slide">
              ...
              <img class="d-block w-100"  src="img/xuong rong-slider2.jpg" alt="Second slide">
              <div class="carousel-caption">
                <a href="product-details-default.html" class="btn btn-lg btn-pink" style=" text-align:justify ;font-size: 45px; font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif">Shop now </a>
            </div>
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="img/senda-slider3.jpg" alt="Third slide">
              <div class="carousel-caption">
                <a href="product-details-default.html" class="btn btn-lg btn-pink" style=" text-align:justify ;font-size: 45px; font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif">Shop now </a>
            </div>
            </div>
                      ...
                      <div class="col-lg-4" >
                          <div class="card border-0 bg-light mb-2">
                              <div class="card-body">
                                ...
                                <img src="{{ 'img/' . $product->images[0]->url }}"
                    ...
                    <div class="col-lg-4" ng-repeat="top in slist">
                        <div class="card border-0 bg-light mb-2">
                            <div class="card-body">
                              <a href="">
                              <img src="{{ 'img/' . $top->images[0]->url}}"
                              width="250px" height="250px" alt="{{ 'img/' . $top->name}}" href="{{ route('product.detail', ['id' => $top->product_id]) }}"></a>
                              {{-- <a href="{{URL::to('/nuts')}}"> --}}
                                <div class="content"> 
                                <a href="{{ route('product.detail', ['id' => $top->product_id]) }}">
